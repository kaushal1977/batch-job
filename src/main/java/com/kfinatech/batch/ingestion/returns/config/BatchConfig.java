...
import com.kfinatech.batch.ingestion.returns.ingestion.VisitorsItemProcessor;
import com.kfinatech.batch.ingestion.returns.repo.VisitorsRepository;
...
public class BatchConfig extends DefaultBatchConfiguration {
    ...
    public FlatFileItemReader<Visitors> flatFileItemReader(@Value("${inputFile}") Resource inputFile){
        ...
        flatFileItemReader.setName("DEV-CSV");
    ...
    public LineMapper<Visitors> linMappe() {
        ...
        BeanWrapperFieldSetMapper<Visitors> fieldSetMapper = new BeanWrapperFieldSetMapper<>();
